...
# Streamlit UI
st.markdown("<h1 style='text-align: center; color: #FF4B4B;'>Facebook Video Downloader</h1>", unsafe_allow_html=True)

# Input for Facebook video URL
st.session_state.video_url = st.text_input("Enter Facebook video URL", st.session_state.video_url)
...
st.sidebar.write("This app allows you to download videos from Facebook by simply providing the video URL.")
st.sidebar.markdown("---")
